...
(** Classify a raw user-typed target token into a {!build_target}: bare
    [@handle] becomes [Overlay_all], [@handle/pkg…] becomes [Overlay_pkg], and
    anything else falls through as [Plain_target]. *)
